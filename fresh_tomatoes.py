...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .poster {
            -webkit-box-shadow: 10px 10px 34px -10px rgba(0,0,0,0.49);
            -moz-box-shadow: 10px 10px 34px -10px rgba(0,0,0,0.49);
            box-shadow: 10px 10px 34px -10px rgba(0,0,0,0.49);
        }
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">Michelle's Favorite Movies</a>
          </div>
        </div>
      </div>
    </div>
